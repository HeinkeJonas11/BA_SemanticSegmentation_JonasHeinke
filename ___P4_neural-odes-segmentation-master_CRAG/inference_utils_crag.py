...
size= (512, 512)     - Größe des Eingangs = Ergebnisbildes, warwick-qu-> (352, 512)
'''
RATIO=(1511/1516) #+
SIZE=(256, 256)   #+
...
#def resize_image(image, ratio=(1511/1516)): #+
def resize_image(image, ratio=RATIO): #+
...
#def pad_image(image, size=(352, 512)):  # WARWICK
#def pad_image(image, size=(512, 512)):    #+CRAG
def pad_image(image, size=SIZE):    #+CRAG    
