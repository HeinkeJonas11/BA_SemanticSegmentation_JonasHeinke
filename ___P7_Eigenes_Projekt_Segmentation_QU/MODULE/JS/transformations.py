...
def create_dense_target(tar: np.ndarray):
    #Gibt die sortierten eindeutigen Elemente eines Arrays zurück. 
    classes = np.unique(tar)
    #Gibt ein Array von Nullen mit derselben Form und demselben Typ wie ein gegebenes Array zurück.
...
class Resize:
    ...
    def __call__(self, inp: np.ndarray, tar: np.ndarray):
        ...
        # print('RES: ', inp_out.shape, tar_out.shape)                         
