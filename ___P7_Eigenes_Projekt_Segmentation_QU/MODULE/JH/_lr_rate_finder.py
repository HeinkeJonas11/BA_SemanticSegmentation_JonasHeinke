...
# Quelle: Lernratenfinder nach Johannes Schmidt, https://github.com/johschmidt42
# Änderungen und Anpaasungen zur Verarbeitung des Datasets CRAG_v2:
# JH. 2021-07-18 . . . 

'''
Inhalt
Klassen:
IdentifyObject - 1. Find the optimal learning rate
'''
...
class LearningRateFinder():
    ...
    def plot(self,
        ...
        plt.ylim(y_lim) 
        titlesize=fontsize+2
        plt.title('Loss = f(learning rate)', fontsize=titlesize )
        plt.xlabel('Learning rate lr', fontsize=fontsize)
        plt.ylabel('Loss (moving average)', fontsize=fontsize)
